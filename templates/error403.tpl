		...
		<section class="errorWrap wrapBlock">
			<header class="caption-header">
				<div class="header-inner">
					<img class="pc_img" src="{$smarty.const.BASE_IMAGE}hone_paget_view.jpg" alt="{$smarty.const.BASE_ALT}403 Forbidden" title="" width="1920" height="660" />
					<img class="sp_img" src="{$smarty.const.BASE_IMAGE}sp_hone_paget_view.jpg" alt="{$smarty.const.BASE_ALT}403 Forbidden" title="" width="640" height="480" />
					<h2 class="header_ttl quicksan">403 Forbidden</h2>
				</div>
			</header>
				...
				<div class="inner">
					<div class="textWrap">
						<p class="catch-comment" data-aos="fade-up" data-aos-delay="200">
							アクセスが禁止されているか、<br />ホストがアクセス禁止処分を受けている可能性があります。<br /><br />
							URLに間違いがないか再度確認いただくか、<br /> メニューよりアクセスしなおしてください。
						</p>
					</div>
				</div>
			</div>
