		...
		<section class="errorWrap wrapBlock">
			<header class="caption-header">
				<div class="header-inner">
					<img class="pc_img" src="{$smarty.const.BASE_IMAGE}hone_paget_view.jpg" alt="{$smarty.const.BASE_ALT}404 Not Found" title="" width="1920" height="660" />
					<img class="sp_img" src="{$smarty.const.BASE_IMAGE}sp_hone_paget_view.jpg" alt="{$smarty.const.BASE_ALT}404 Not Found" title="" width="640" height="480" />
					<h2 class="header_ttl quicksan">404 Not Found</h2>
				</div>
			</header>
				...
				<div class="inner">
					<div class="textWrap">
						<p class="catch-comment" data-aos="fade-up" data-aos-delay="200">
							大変申し訳ございません・・・・お探しのページは見つかりませんでした。<br>
							お探しのページは一部的のアクセスできない状況にあるか、<br>
							移動もしくは削除された可能性があります。
						</p>
					</div>
				</div>
